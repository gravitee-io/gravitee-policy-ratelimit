...
public class RateLimitKeyFactory {
    ...
    private static final String RATE_LIMIT_TYPE = "sa";
     ...
     */
    public static String createRateLimitKey(ExecutionContext executionContext, SpikeArrestConfiguration configuration) {
