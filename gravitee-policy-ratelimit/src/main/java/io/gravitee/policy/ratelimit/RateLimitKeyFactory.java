...
public class RateLimitKeyFactory {
    ...
    private static final String RATE_LIMIT_TYPE = "rl";
     ...
     */
    public static String createRateLimitKey(ExecutionContext executionContext, RateLimitConfiguration configuration) {
